...
<div class="toolbox-content flex flex-col text-primary-900 dark:text-primary-100">
	...
	<main class="grid grid-cols-1 gap-4">
		<button
			class="btn btn-create border border-primary-400 bg-primary-200/70 hover:bg-primary-300/80 text-primary-800 hover:border-primary-500 transition-colors"
		...
		<button
			class="btn btn-create border border-secondary-400 bg-secondary-200/70 hover:bg-secondary-300/80 text-secondary-800 hover:border-secondary-500 transition-colors"
	...
	<footer class="flex justify-center">
		<div class="search-bar w-full px-2">
			<input
				type="text"
				placeholder="Search..."
				class="input bg-primary-50 border-primary-300 text-primary-800 placeholder-primary-500 focus:border-primary-500 focus:ring-primary-500"
			/>
		</div>
	</footer>
</div>
