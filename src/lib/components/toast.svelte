...
>
	...
	<span class="text-xs text-slate-800 dark:text-slate-200 break-words whitespace-pre-line"
		>{toast.message}</span
	>
	<button
		class="absolute right-2 top-2 size-6 bg-white/70 dark:bg-slate-800/70 hover:bg-red-100 dark:hover:bg-red-900/40 text-slate-700 dark:text-slate-200 flex items-center justify-center"
