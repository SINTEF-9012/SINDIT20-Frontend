...
The URL and the URI-prefix of the backend are defined as environment variables (`PUBLIC_SINDIT_BACKEND_API` and `PUBLIC_SINDIT_BACKEND_API_BASE_URI`), see also the subsection _Environment_ above.
